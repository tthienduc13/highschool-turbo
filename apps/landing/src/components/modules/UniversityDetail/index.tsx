      ...
      <footer className="bg-gray-900 py-12 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div>
              <h3 className="mb-4 text-xl font-bold">UniGuide</h3>
              <p className="text-gray-400">
                Nền tảng hỗ trợ học sinh tìm kiếm và lựa chọn trường đại học phù
                hợp nhất với mục tiêu và sở thích của mình.
              </p>
            </div>
            <div>
            ...
            <div>
              <h4 className="mb-4 font-semibold">Tài nguyên</h4>
              <ul className="space-y-2">
                <li>
                ...
                <li>
                  <Link className="text-gray-400 hover:text-white" href="/tips">
                    Mẹo chọn trường
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-400">Email: contact@uniguide.vn</li>
                <li className="text-gray-400">Điện thoại: (024) 1234 5678</li>
                <li className="text-gray-400">Địa chỉ: Hà Nội, Việt Nam</li>
              </ul>
            </div>
          </div>
          <div className="mt-8 border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2025 UniGuide. Tất cả các quyền được bảo lưu.</p>
          </div>
        </div>
      </footer>
    </div>
