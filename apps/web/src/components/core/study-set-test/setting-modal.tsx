...
>(({ className, thumbClassName, questionCount, ...props }, ref) => (
    ...
    >
        ...
        <SliderPrimitive.Thumb
            className={cn(
                "relative block h-10 w-10 rounded-full border-[4px] border-blue-500 bg-white shadow-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:border-blue-500 dark:bg-gray-800",
