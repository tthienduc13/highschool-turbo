...
export const Footer = () => {
  ...
  return (
    <footer className="relative mt-20 size-full overflow-x-hidden">
      <div className="absolute top-0 -z-10 h-full w-[400%] max-w-[4000px] opacity-10 blur-[30px] lg:w-[150%]">
      ...
      <div className="z-50 mx-auto flex w-full max-w-5xl flex-col gap-10 p-4 py-8 lg:p-10">
        <div className="flex flex-col gap-2 md:flex-row md:items-center">
          ...
          <Separator className="hidden h-5 md:flex" orientation="vertical" />
