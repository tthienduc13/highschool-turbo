    ...
    return (
        <section className="flex flex-col gap-6 text-center justify-center items-center">
            ...
            <div className="font-medium">
                Highschool cung cấp dịch vụ chuyên nghiệp cho tất cả học sinh
                trên toàn thế giới nói chung và học sinh tại Việt Nam nói riêng
                để vượt qua kỳ thi Trung học Phổ thông Quốc gia.
            </div>
            <Button
