...
import { WriteData } from "@/components/core/study-set-remembered/types";
import { LoadingView } from "@/components/core/study-set-test/loading-view";
import { Container } from "@/components/core/layouts/container";
import { TestView } from "@/components/core/study-set-remembered/test-view";
import { ResultView } from "@/components/core/study-set-remembered/result-view";

function StudySetRememberedModule() {
  return (
    <PhotoViewProvider>
      <EditorGlobalStyles />
      <CreateTestData>
...
export default StudySetRememberedModule;

const TestContainer = () => {
  const store = useContext(RememberedContext)!;
  const result = useRememberedContext((s) => s.result);
  const setEndedAt = useRememberedContext((s) => s.setEndedAt);
  const submit = useRememberedContext((s) => s.submit);
