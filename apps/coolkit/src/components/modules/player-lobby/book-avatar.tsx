...
export const BookAvatar = ({
  ...
  const AnimalCard = ({
    ...
    <motion.button
      ...
      disabled={!isUnLock}
    >
      {isUnLock && <RarityBadge rarity={avatar.rarity} />}
      ...
      <div className="relative flex flex-col items-center gap-2 rounded-lg bg-white p-2 shadow-sm ring-1 ring-amber-900/5">
        {!isUnLock && (
          <div className="bg-background/80 absolute inset-0 z-10 flex items-center justify-center rounded-lg backdrop-blur-[2px]">
            <IconLock className="text-muted-foreground h-8 w-8" />
          </div>
        )}
  ...
  return (
    <div className="h-[80vh] w-[56vw]">
      ...
      <div className="relative mx-auto aspect-[2/1.4]">
        ...
        <div className="bg-game-winter absolute inset-0 rounded-lg shadow-2xl">
