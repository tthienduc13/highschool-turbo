        ...
        <div className={cn("space-y-4", className)}>
                ...
                >
                    {singleImage ? (
                        <div className="relative">
                            <div
                                className="relative aspect-square w-full max-w-[200px] mx-auto overflow-hidden rounded-lg cursor-pointer group"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                ...
                                {multiImages.length < maxImages && (
                                    <div
                                        className="relative aspect-square border-2 border-dashed rounded-lg flex items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors"
                                        onClick={() => multiInputRef.current?.click()}
                                    >
                                        <div className="flex flex-col items-center justify-center text-center p-2">
                                            <IconUpload className="h-8 w-8 text-muted-foreground mb-1" />
            ...
            >
                <DialogContent className="max-w-[90vw] max-h-[90vh] w-fit h-fit p-0 overflow-hidden">
                    <div className="relative bg-black/90 flex flex-col h-full">
                        <div className="absolute top-2 right-2 z-10 flex gap-2">
                            <Button
                                className="h-8 w-8 bg-black/50 border-0 text-white hover:bg-black/70"
                                size="icon"
                                variant="outline"
                        ...
                        {mode === "multiple" && multiImages.length > 1 && (
                            <>
                                <Button
                                    className="absolute left-2 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-black/50 border-0 text-white hover:bg-black/70 z-10"
                                    size="icon"
                                    variant="outline"
                                ...
                                <Button
                                    className="absolute right-2 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-black/50 border-0 text-white hover:bg-black/70 z-10"
                                    size="icon"
                                    variant="outline"
                        ...
                        <div className="px-3 bg-black/80 text-white text-sm flex justify-between items-center">
                            {mode === "multiple" ? (
                                <span>
