...
export const ExperienceRatingChart = () => {
    const data = [
        { experience: 1, rating: 3.2, count: 12 },
        { experience: 2, rating: 3.5, count: 15 },
        { experience: 3, rating: 3.7, count: 18 },
        { experience: 4, rating: 3.9, count: 22 },
        { experience: 5, rating: 4.0, count: 25 },
        { experience: 6, rating: 4.1, count: 20 },
        { experience: 7, rating: 4.2, count: 18 },
        { experience: 8, rating: 4.3, count: 15 },
        { experience: 9, rating: 4.4, count: 12 },
        { experience: 10, rating: 4.5, count: 10 },
        { experience: 11, rating: 4.6, count: 8 },
        { experience: 12, rating: 4.6, count: 7 },
        { experience: 13, rating: 4.7, count: 5 },
