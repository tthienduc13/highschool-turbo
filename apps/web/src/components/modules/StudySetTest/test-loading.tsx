...
export const QuestionSkeleton = () => {
    return (
        <Card className="relative rounded-2xl border-2 border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
            <div className="sm:px-6 sm:py-5 space-y-6 px-5 py-5 md:px-8 md:py-7">
                <div className="sm:grid-cols-[1fr_2px_1fr] grid grid-cols-1 gap-1 md:gap-3">
                    <div className="sm:pr-4 w-full pr-0">
                        <SkeletonPromptDisplay label="Definition" />
                    </div>
                    <div className="sm:block hidden bg-gray-200 dark:bg-gray-700" />
                    <div className="sm:hidden my-4 block h-0.5 w-full bg-gray-200 dark:bg-gray-700" />
                    <div className="sm:pl-4 w-full pl-0">
