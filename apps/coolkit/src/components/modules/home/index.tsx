...
import { QuestionSetCard, RecommendCardQuestion } from '@/components/core/common/cards/recommend-card-question';
...
function HomeModule() {
    return (
        <div className='container mx-auto px-6'>
            ...
            <div className="mb-12">
                <h2 className="text-3xl font-bold text-gray-800 mb-2">Gợi ý bộ câu hỏi</h2>
                <p className="text-gray-600 mb-6">Khám phá những kiến thức trong các bộ câu hỏi</p>
