...
export const GenericCard = ({
  ...
  return (
    <Link passHref href={url}>
      <div
        className="hover:border-b-primary  cursor-pointer rounded-lg border-2 border-gray-200 bg-white p-5 shadow-md transition-all duration-200 ease-in-out hover:-translate-y-2 dark:border-gray-700 dark:bg-gray-800"
