...
export const ButtonAudio = ({ className, sizeIcon, heightShadow }: ButtonAudioProps) => {
    ...
    return (
        <>
            ...
            >
                {
                    isTurnOnMusic ? (
                        <IconVolume style={{ width: `${sizeIcon ?? '1.4rem'}`, height: `${sizeIcon ?? '1.4rem'}` }} />
                    ) : (
                        <IconVolumeOff style={{ width: `${sizeIcon ?? '1.4rem'}`, height: `${sizeIcon ?? '1.4rem'}` }} />
                    )
                }
            </ButtonKet>
        </>
